...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'root@lscube7.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/LSCube7',
    },
    {
      name: 'Blog',
      link: 'https://blog.lsc7.top',
    },
  ],
